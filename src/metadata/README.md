 ...
 * [ODKTestUpdateRepo.yml](ODKTestUpdateRepo.yml)
     * Determines how your purl.obolibrary.org/obo/ODKTestUpdateRepo/ redirects will be handled
     ...
     * Paste in the contents of [ODKTestUpdateRepo.yml](ODKTestUpdateRepo.yml)
 ...
 * [ODKTestUpdateRepo.md](ODKTestUpdateRepo.md)
     ...
     * Paste in the contents of [ODKTestUpdateRepo.md](ODKTestUpdateRepo.md)
     * Click "Commit new file"
     * IMPORTANT: remember to make a pull request
     * An OBO admin will merge your Pull Request *providing it meets the requirements of the OBO library*
